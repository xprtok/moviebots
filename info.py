...
API_ID = int(environ.get('API_ID', '20832372')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '8434421453:AAFGKrE7Z9NBWtXA5kJpuh4x_t5tVm7Du6Y')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8434421453:AAFGKrE7Z9NBWtXA5kJpuh4x_t5tVm7Du6Y")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/pztbtb.jpg')).split()  # Sample pic
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002339045325').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002022497761'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002022497761'))  # Bin channel id (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', '0')    # QR code image for payments
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003562180917'))  # Notification of sent to your channel
...
TUTORIAL = environ.get("TUTORIAL", "0")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "0")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "0")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "0") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 0") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "0")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "0") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "0")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "0") # Shortener website for third website
